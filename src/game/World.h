...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_ENABLE_WARDEN,
    CONFIG_BOOL_WARDEN_ROOT_HACK,
    CONFIG_BOOL_WARDEN_SLOWFALL_HACK,
    CONFIG_BOOL_WARDEN_WATERWALK_HACK,
    CONFIG_BOOL_WARDEN_LEVITATE_HACK,
    CONFIG_BOOL_WARDEN_FLY_HACK,
    CONFIG_BOOL_WARDEN_SPEED_HACK,
    CONFIG_BOOL_WARDEN_AIRSWIM_HACK,
